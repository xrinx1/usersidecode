...
<!-- navigation start -->
<nav id="nav" class="navbar navbar-expand bg-light py-2 px-0 sticky-top" style="box-shadow:  0px -3px 9px 0px #123;">
  <div class="container-fluid">
    <div style="margin:auto; width:70%;">
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div>
          <!-- <div class="logo-container rounded-full ">
            <img src="assests/logo/slide4.webp"></img>
          </div> -->
          <div class="col-md-4">
          
            <!-- Image with img-fluid class -->
            <img src="assests/logo/logo2.jpg" class="img-fluid" alt="Responsive image">
          </div>
          <div class="text-left mt-0" style="font-family: 'Noto Serif JP', sans-serif; user-select: none;"> Look Eyewear</div>
        </div>
        <ul class="navbar-nav  me-5 mb-1 mb-lg-0">
          <li class="nav-item">
